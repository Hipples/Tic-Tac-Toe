...
The child class prompts user input related to the menu options, captures specified game settings,
and starts the chosen game mode!
"""
...
class PlayerSelections(TicTacToeMenus):
    ...
    def __init__(self):
        """
        PlayerSelections initializes all parent methods and adds the following class variables:
    ...
    def get_player_selection(self):
        """
        Returns players selections as integers. Catches and reprompts input errors.
        Accepts Ctrl + c as shortcut to quit out of program during user input.
        """
        while True:
            try:
                selection = int(input("\n\tPlayer Selection: "))
    ...
    def board_options(self):
        """
        Allows user to choose the board size for their game (3x3 or 5x5).
...
# pylint results only called out considering sys.exit() over exit() on lines 158, 204, and 219
# no pylama results
#   - June 19, 2022
